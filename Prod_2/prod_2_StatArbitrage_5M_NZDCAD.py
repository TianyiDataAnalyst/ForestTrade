...
def candles(instrument):
    params = {"count": 1300,"granularity": list(CandlestickGranularity)[5]} #granularity is in 'M15'; it can be in seconds S5 - S30, minutes M1 - M30, hours H1 - H12, days D[18], weeks W or months M
...
StatArb_VALUE_FOR_BUY_ENTRY = var_prod_2.VALUE_FOR_BUY_ENTRY  # StatArb trading signal value aboe which to enter buy-orders/long-position
StatArb_VALUE_FOR_SELL_ENTRY = var_prod_2.VALUE_FOR_SELL_ENTRY  # StatArb trading signal value below which to enter sell-orders/short-position
...
NUM_SHARES_PER_TRADE = var_prod_2.NUM_SHARES_PER_TRADE  # Number of currency to buy/sell on every trade
MIN_PROFIT_TO_CLOSE = var_prod_2.pnl_value # Minimum Open/Unrealized profit at which to close positions and lock profits
