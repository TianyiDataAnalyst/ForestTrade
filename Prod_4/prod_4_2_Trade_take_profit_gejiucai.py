...
#Globle variable 
trade_instrument = var_prod_4.TRADING_INSTRUMENT
NUM_SHARES_PER_TRADE = var_prod_4.NUM_SHARES_PER_TRADE 
...
def main():
    ...
    for trade_id in trade_ids:       
        ...
        pnl_value = var_prod_4.pnl_value
        if pnl > pnl_value or pnl < -1*(pnl_value): # and time_threshold(trade_id) > 899:
            print("Close trade:")
