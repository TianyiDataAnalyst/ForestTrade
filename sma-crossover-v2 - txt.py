...
def candles(instrument):
    params = {"count": 250,"granularity": list(CandlestickGranularity)[0]} #granularity is in 'S5'; it can be in seconds S5 - S30, minutes M1 - M30, hours H1 - H12, days D, weeks W or months M
...
"""
df=candles('EUR_USD')
df['sma_fast']=df['c'].rolling(10).mean() 
df['sma_slow']=df['c'].rolling(20).mean()
