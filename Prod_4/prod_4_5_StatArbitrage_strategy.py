...
StatArb_VALUE_FOR_BUY_ENTRY = var_prod_4.VALUE_FOR_BUY_ENTRY  # StatArb trading signal value aboe which to enter buy-orders/long-position
StatArb_VALUE_FOR_SELL_ENTRY = var_prod_4.VALUE_FOR_SELL_ENTRY  # StatArb trading signal value below which to enter sell-orders/short-position
...
NUM_SHARES_PER_TRADE = var_prod_4.NUM_SHARES_PER_TRADE  # Number of currency to buy/sell on every trade
MIN_PROFIT_TO_CLOSE = var_prod_4.pnl_value  # Minimum Open/Unrealized profit at which to close positions and lock profits
...
with open("C:\\Users\\gutia\\Anaconda3\\ForestTrade\\log\\prod_4_4_final_delta_projected.txt","a+") as f:
