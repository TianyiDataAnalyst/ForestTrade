...
positions_container = []  # Container for tracking positions, +ve for long positions, -ve for short positions, 0 for flat/no position
pnls_container = []  # Container for tracking total_pnls, this is the sum of closed_pnl i.e. pnls already locked in and open_pnl i.e. pnls for open-position marked to market price
...
#     if i > 1498:
#         print(symbols_data['CAD_USD']['Close'].iloc[i])
#         print(symbols_data['CAD_USD'].index[i])
#         print(i)
# =============================================================================
...
def main():
    ...
    # =============================================================================
      ...
      positions_container.append(position)
      ...
      pnls_container.append(closed_pnl + open_pnl)
...
# delta_projected_actual_data = delta_projected_actual_data.assign(Position=pd.Series(positions_container, index=symbols_data[TRADING_INSTRUMENT].index))
# delta_projected_actual_data = delta_projected_actual_data.assign(Pnl=pd.Series(pnls_container, index=symbols_data[TRADING_INSTRUMENT].index))
# 
