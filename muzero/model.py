# -*- coding: utf-8 -*-
"""
Created on Sun May 10 23:49:26 2020
...
class MuModel():
  ...
  def create_mu(self, K, lr):
    ...
    def softmax_ce_logits(y_true, y_pred):
      return tf.compat.v1.nn.softmax_cross_entropy_with_logits_v2(y_true, y_pred)#tf.nn.softmax_cross_entropy_with_logits_v2(y_true, y_pred)
