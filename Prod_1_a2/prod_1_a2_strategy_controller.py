...
def main():
    os.system('python C:\\Users\\gutia\\Anaconda3\\ForestTrade\\Prod_1_a2\\prod_1_1_2_a2_StatArbitrage_strategy.py')
...
while time.time() <= timeout:
    try:
        print("account demo2:", "Strategy_controler script passthrough at ",time.strftime('%Y-%m-%d %H:%M:%S', time.localtime(time.time())))
        main()
